...
SELECT c.first_name, c.last_name, recent_film.title, recent_film.rental_date
FROM customer c
LEFT JOIN LATERAL (
	SELECT film.title, rental.rental_date, rental.customer_id
	FROM film
